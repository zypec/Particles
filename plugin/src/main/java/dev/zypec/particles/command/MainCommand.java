...
import dev.zypec.particles.Plugin;
...
import dev.zypec.particles.locale.Locale;
...
public class MainCommand extends BaseCommand {
    ...
    public MainCommand(Plugin plugin) {
        ...
        this.guiManager = Particles.getGUIManager();
    }
    ...
    public void selectGroupColor(Player player, @Name("%effect") String key, @Single String color) {
        ...
        var colorScheme = Particles.getColorManager().getColorScheme(color);
        if (colorScheme == null) {
    ...
    public void toggleNotifications(Player player) {
        if (!Particles.isNotificationsEnabled()) {
    ...
    public void debugInfo(CommandSender sender) {
        ...
        MessageUtils.sendParsed(sender, "<prefix> <gray>Color Cycle Speed: <gold>" + Particles.getGUIManager().getColorCycleSpeed());
        MessageUtils.sendParsed(sender, "<prefix> <gray>Animation Interval: <gold>" + Particles.getGUIManager().getInterval());
    }
