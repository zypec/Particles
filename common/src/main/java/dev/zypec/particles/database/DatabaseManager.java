package dev.zypec.particles.database;

import dev.zypec.particles.Particles;
import dev.zypec.particles.database.impl.MySQL;
import dev.zypec.particles.database.impl.SQLite;
...
public class DatabaseManager {
    ...
    public boolean initialize() {
        var config = Particles.getConfig();
        ...
        TYPE = type;
        TABLE = config.getString("database.table", "particles_data");
