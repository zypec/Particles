package dev.zypec.particles.effect.script.particle.reader.text;
...
import dev.zypec.particles.effect.script.particle.style.text.animated.AnimatedTextParticle;
import dev.zypec.particles.effect.script.particle.style.text.animated.AnimationOrigin;
