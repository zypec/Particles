...
import dev.zypec.particles.color.group.ColorGroup;
import dev.zypec.particles.constants.Patterns;
import dev.zypec.particles.effect.data.EffectData;
import dev.zypec.particles.effect.data.EmptyEffectData;
...
import dev.zypec.particles.effect.script.Cached;
import dev.zypec.particles.effect.script.Script;
import dev.zypec.particles.effect.script.Script.TickResult;
import dev.zypec.particles.effect.script.conditional.ConditionalScript;
...
public class Effect {
    ...
    public void configure() {
        ...
        if (!Particles.getGUIManager().showSupportedEvents()) return;
