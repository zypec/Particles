package dev.zypec.particles.gui.type;
...
import dev.zypec.particles.gui.type.effects.EffectsHolder;
...
import static dev.zypec.particles.gui.config.GUIElements.ElementInfo;
...
public abstract class GUI {
    ...
    protected GUI(GUIManager manager, GUIType type) {
        ...
        this.translations = Particles.getTranslations();
    }
