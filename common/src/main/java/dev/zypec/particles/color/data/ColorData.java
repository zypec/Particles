...
import dev.zypec.particles.color.data.duo.DuoColorData;
import dev.zypec.particles.color.data.duo.DuoColorsData;
import dev.zypec.particles.color.data.dynamic.DynamicColorData;
...
import dev.zypec.particles.util.math.IntRange;
...
public class ColorData {
    ...
    public static ColorData fromString(String input) throws ReaderException {
        ...
        if (note) {
            ...
            var colorScheme = Particles.getColorManager().getColorScheme(colorName);
            if (colorScheme == null) throw new ReaderException("Unexpected color scheme name value: " + colorName);
            if (duoName != null) {
                var duoScheme = Particles.getColorManager().getColorScheme(duoName);
                if (duoScheme == null) {
                    try {
