...
public class NMSMatcher {
    ...
    static {
        ...
        registerVersion("v1_21_R7", "21.11");
    }
    ...
    public static AbstractNMSHandler match() {
        ...
        try {
            var builderClass = Class.forName("dev.zypec.particles.version." + serverVersion + ".NMSHandler");
            ...
            Bukkit.getLogger().log(Level.WARNING, "Bukkit version: " + Bukkit.getBukkitVersion() + " (Found: " + ReflectionUtils.MINECRAFT_VERSION_CONVERTED + ")");
            Bukkit.getLogger().warning("Particles does not support server version " + ReflectionUtils.MINECRAFT_VERSION_CONVERTED);
        }
        return null;
    }
}