package dev.zypec.particles.permission;
...
public class Permissions implements DataHolder {
    ...
    public boolean initialize() {
        ...
        var replacements = Particles.getCommandManager().getCommandReplacements();
    ...
    public String replace(String key) {
        ...
        if (matcher.find()) {
            ...
            var replaced = Particles.getConfig().getString("permissions." + perm);
