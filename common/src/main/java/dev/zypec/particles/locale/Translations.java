package dev.zypec.particles.locale;
...
public class Translations implements DataHolder {
    ...
    public boolean initialize() {
        ...
        try {
            LOCALE = Objects.requireNonNull(Particles.getConfig().getString("locale", "en")).toLowerCase(java.util.Locale.ENGLISH);
            ...
            if (config == null) {
                ...
                Particles.getConfig().set("locale", LOCALE);
    ...
    public void loadTranslations() {
        // General
        PREFIX = load("prefix", "<b><gradient:#EF476F:#FFD166>Particles</b> <dark_gray><b>|</b></dark_gray>");
        NOTIFICATION = load("notification", "<prefix> <b><download>Download</download></b> <dark_gray>/</dark_gray> <b><github>GitHub</github></b> <dark_gray>/</dark_gray> <b><wiki>Wiki</wiki>");
        ...
        // Effects GUI
        EFFECTS_GUI_TITLE = load("gui.effects-gui.title", "      <gradient:#EF476F:#FFD166><b>Particles");
        ...
        //-Reload
        RELOADING = load("commands.reloading", "<prefix> <yellow>Reloading Particles");
