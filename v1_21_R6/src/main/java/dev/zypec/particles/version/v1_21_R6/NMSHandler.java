package dev.zypec.particles.version.v1_21_R6;
...
import dev.zypec.particles.version.v1_21_R6.data.NMSGenericData;
import dev.zypec.particles.version.v1_21_R6.data.color.NMSColorData;
import dev.zypec.particles.version.v1_21_R6.data.color.NMSDustData;
import dev.zypec.particles.version.v1_21_R6.data.color.NMSDustTransitionData;
import dev.zypec.particles.version.v1_21_R6.data.color.NMSSpellData;
...
public class NMSHandler extends AbstractNMSHandler {
    ...
    public void strikeLightning(Location location, Predicate<Player> filter) {
        ...
        var lightning = new EntityLightning(EntityTypes.aA, ((CraftWorld) location.getWorld()).getHandle());
